...
# 사용법: source scripts/setup_aliases.sh
...
# Python 실행 별칭들
alias pillsnap-python='./scripts/python_safe.sh'
alias pp='./scripts/python_safe.sh'  # 짧은 별칭
alias ptest='./scripts/python_safe.sh -m pytest'
alias ppip='./scripts/python_safe.sh -m pip'

# 자주 사용하는 명령어들
alias pillsnap-env='source scripts/env/activate_environment.sh'
alias pillsnap-test='./scripts/python_safe.sh -m pytest'
alias pillsnap-lint='./scripts/python_safe.sh -m ruff check'
alias pillsnap-format='./scripts/python_safe.sh -m black'
