...
| **Stage 4** | 500,000장 | 5,000개 | 최종 프로덕션 학습 | 120시간 (5일) |
...
def progressive_sampling_strategy():
    ...
    Stage 4 (500,000장): 전체 5,000개 클래스
    - 클래스당 평균 100장, 최종 프로덕션 성능
    """
    pass
```
...
#### **Stage 4: 최종 목표 (500,000장, 5,000클래스)** 
```yaml  
target_metrics:
  detection:
...
# Stage 4 완료 조건
stage4_complete:
  classification_accuracy: ≥0.92 (5,000클래스)
...
### 데이터 구조
- **총 200개 ZIP 파일**
  - Training: 178개 (라벨링 89개, 원천 89개)
  - Validation: 22개 (라벨링 11개, 원천 11개)
- **압축 용량**: 약 4.2TB
- **해제 후 예상**: 약 5.1TB
- **이미지 수**: 약 500,000장
- **약품 종류**: 
  - 단일 약품: 5,000종 (개별 약품 이미지)
  - 조합 약품: 5,000종 조합 (여러 약품이 한 이미지에)
